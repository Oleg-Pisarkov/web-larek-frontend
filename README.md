...
- `order:success` - открытие модального окна успешной покупки 
- `success:close` - закрытие модального окна успешной покупки, обновление счетчика товаров в корзине, обновление форм адреса и контактов
